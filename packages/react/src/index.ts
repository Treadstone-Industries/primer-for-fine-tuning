...
export {default as AvengersList} from './AvengersList'
export type {AvengersListProps} from './AvengersList'
...
export {default as StarkPatentTracker} from './StarkPatentTracker'
